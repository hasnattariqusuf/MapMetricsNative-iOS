Pod::Spec.new do |spec|
  spec.name         = "MapMetrics"  # Must match filename (MapMetrics.podspec)
  spec.version      = "0.0.1"
  ...
  spec.swift_version = "5.0"  # Added Swift version
  ...
  spec.pod_target_xcconfig = {
    ...
    "ENABLE_USER_SCRIPT_SANDBOXING" => "NO"  # Added sandbox fix
  }
